...
sed -i "3i uci set network.lan.ipaddr='192.168.50.1'" ./package/lean/default-settings/files/zzz-default-settings
...
sed -i "6i uci set network.lan.ifname='eth1 eth2'" ./package/lean/default-settings/files/zzz-default-settings  # 网络端口：默认 eth0，第一个接口
